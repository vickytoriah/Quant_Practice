...
CoordMatrix::RandomWalk(const random_numbers& random_numbers) { // i need to create an array of random integers within a lower and upper bound
...
void CoordMatrix::addCoord(int x, int y, const NSEW& nsew_dict) {
